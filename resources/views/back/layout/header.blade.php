            ...
            <div class="items-center space-x-4 rtl:space-x-reverse horizental-box">
                <a href="index.html">
                    <span class="xl:inline-block hidden">
                        <img src="{{ asset('backend/assets/images/logo/logo.svg') }}" class="black_logo "
                            alt="logo">
                        <img src="{{ asset('backend/assets/images/logo/logo-white.svg') }}" class="white_logo"
                            alt="logo">
                    </span>
                    <span class="xl:hidden inline-block">
                        <img src="{{ asset('backend/assets/images/logo/logo-c.svg') }}" class="black_logo "
                            alt="logo">
                    </span>
                </a>
                <button class="smallDeviceMenuController  open-sdiebar-controller xl:hidden inline-block">
                    <iconify-ico
                        class="leading-none bg-transparent relative text-xl top-[2px] text-slate-900 dark:text-white"
                        icon="heroicons-outline:menu-alt-3"></iconify-ico>
                </button>
                        ...
                        <ul class="py-1 text-sm text-slate-800 dark:text-slate-200">
                            ...
                            <li>
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <a href="{{ route('logout') }}"
                                        class="block px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white font-inter text-sm text-slate-600 dark:text-white font-normal" onclick="event.preventDefault();
