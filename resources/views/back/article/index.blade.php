...
@section('title', 'Article List - Admin')
                    ...
                    <div class=" space-y-5">
                        <div class="card">
                            <header class=" card-header noborder">
                                <h4 class="card-title">Article List
                                </h4>
                                <a href="{{ url('article/create') }}"
                                    class="btn inline-flex justify-center btn-success rounded-[50px]">
                                                    ...
                                                    @foreach ($articles as $item)
                                                        <tr>
                                                            ...
                                                            @if ($item->status == 0)
                                                                <td>
                                                                    <span
                                                                        class="badge bg-danger-500 text-white capitalize pill">Private</span>
                                                                </td>
                                                            @else
                                                                <td>
                                                                    <span
                                                                        class="badge bg-success-500 text-white capitalize pill">Published</span>
                                                                </td>
                                                            @endif
                                                                    ...
                                                                    <div class="relative">
                                                                        <div class="dropdown relative">
                                                                            ...
                                                                            <ul
                                                                                ...
                                                                                <li>
                                                                                    <a href="#" onclick="deleteArticle(this)" data-id="{{ $item->id }}"
                                                                                        class="text-slate-600 dark:text-white block font-Inter font-normal px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white">
                                                                                        Delete
                                                                                    </a>
                                                                                </li>
