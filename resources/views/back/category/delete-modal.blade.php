...
id="categoryDeleteModal{{ $item->id }}" tabindex="-1" aria-labelledby="disabled_backdrop" aria-hidden="true" data-bs-backdrop="static"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
            ...
            <form action="{{ url('categories/'.$item->id) }}" method="POST">
                ...
                <div class="flex items-center justify-end p-6 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
                    <button type="submit" class="btn inline-flex justify-center text-white bg-red-500">Delete</button>
                </div>
            </form>
